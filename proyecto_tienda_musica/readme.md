...
*   **Atributos:**
    ...
    *   `FechaRegistro`: Fecha en que el cliente se registró.
...
![Diagrama Entidad-Relaci��n de Tienda de M��sica](./err_tienda_musica.png)
...
### Pasos para configurar (próximamente):
1.  Instalación de MySQL.
2.  Creación de la base de datos `tienda_musica`.
3.  Ejecución de los scripts SQL para la creación de tablas e inserción de datos de ejemplo.
